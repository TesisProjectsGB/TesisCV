...
@Component({
  selector: 'app-pdf-one-content-format2',
  templateUrl: './pdf-one-content-format2.component.html',
  styleUrls: ['./pdf-one-content-format2.component.scss']
})
export class PdfOneContentFormat2Component implements OnInit {
